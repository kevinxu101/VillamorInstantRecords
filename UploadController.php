...
use App\Imports\FirstStudentSheetImport;
use App\Imports\FirstTeacherSheetImport;
...
class UploadController extends Controller {
  ...
  public function import(Request $request){
      ...
      try{ 
        ...
        Excel::import(new FirstStudentSheetImport, $path);

       
    
          return back()->with('student', 'Successfully added student');
        }
      
          else if($request->type == 'teacher'){
    
         Excel::import(new FirstTeacherSheetImport, $path);

             //logs table (hanapin mo muna )
             Logs::create([
              'userid'           =>  auth()->user()->id,
              'activity'          => "import teachers",
          ]);

        return back()->with('teacher', 'Successfully added teachers');
